<template>
    <div>
      ...
      <div class="e" style="width:500px;height:500px" ref="chart"></div>
      <br>
      <button @click="drawLeiDa">draw</button>
      <div class="e" style="width:500px;height:500px" ref="chartLeiDa"></div>
      <button @click="drawGraph">draw</button>
      <div class="e" style="width:500px;height:500px" ref="chartGraph"></div>
    ...
    export default {
        ...
        methods: {
          ...
          drawLeiDa(){
            ...
            let myChart = this.$echarts.init(this.$refs.chartLeiDa);
            console.log(this.$refs.chartLeiDa)
            // 绘制图表
            myChart.setOption(option);
          },
          drawGraph(){
            let myChart = this.$echarts.init(this.$refs.chartGraph);

            $.getJSON('/home/jun/桌面/web_project/vue-admin-template/internet.graph.json', function (graph) {
